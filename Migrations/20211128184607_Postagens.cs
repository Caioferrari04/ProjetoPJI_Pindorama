...
{
    public partial class Postagens : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPostagem = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Postagens_Game_ComunidadeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostagemPaiId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comentarios_Postagens_PostagemPaiId",
                        column: x => x.PostagemPaiId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comentarios_PostagemPaiId",
                table: "Comentarios",
                column: "PostagemPaiId");

            migrationBuilder.CreateIndex(
                name: "IX_Postagens_ComunidadeId",
                table: "Postagens",
                column: "ComunidadeId");
